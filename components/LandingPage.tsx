            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
               <div className="md:col-span-1 text-center md:text-left">
                  <div className="flex items-center justify-center md:justify-start mb-4">
                    <img src="/predi-cloud-logo.png" alt="Predi" className="h-16 md:h-12 w-auto object-contain" />
                  </div>
                  ...
                  <a 
                    ...
                    className="inline-flex items-center justify-center md:justify-start gap-2 text-gray-400 hover:text-neo-pink transition-colors text-sm font-bold w-full md:w-auto"
                  >
